 ...
 * 
 */
@WebServiceClient(name = "BankWs", targetNamespace = "http://ws.example.org/", wsdlLocation = "http://localhost:8089/BankWs?wsdl")
public class BankWs
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8089/BankWs?wsdl");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://ws.example.org/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.example.org/", "BankServicePort"), BankService.class, features);
    }
